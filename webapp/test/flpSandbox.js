		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#assignmentcurd-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"assignmentcurd-display": {
								"semanticObject": "assignmentcurd",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=assignmentcurd",
									"url": sap.ui.require.toUrl("assignmentcurd")
								}
							}
						}
					}
